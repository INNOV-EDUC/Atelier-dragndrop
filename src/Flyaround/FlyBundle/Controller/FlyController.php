...
namespace Flyaround\FlyBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use Flyaround\FlyBundle\Entity\Fly;
use Flyaround\FlyBundle\Form\FlyType;
...
class FlyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FlyaroundFlyBundle:Fly')->findAll();

        return $this->render('FlyaroundFlyBundle:Fly:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FlyaroundFlyBundle:Fly:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FlyaroundFlyBundle:Fly')->find($id);
        ...
        return $this->render('FlyaroundFlyBundle:Fly:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FlyaroundFlyBundle:Fly:edit.html.twig', array(
            'entity'      => $entity,
